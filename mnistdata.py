...
def download_and_ungzip(filename, work_directory, source_url):
    if filename[-3:] == ".gz":
...
def load_mnist_data(data_dir):
    ...
    local_train_images_file = download_and_ungzip(train_images_file, data_dir, SOURCE_URL + train_images_file)
    train_labels_file = 'train-labels-idx1-ubyte.gz'
    local_train_labels_file = download_and_ungzip(train_labels_file, data_dir, SOURCE_URL + train_labels_file)
    test_images_file = 't10k-images-idx3-ubyte.gz'
    local_test_images_file = download_and_ungzip(test_images_file, data_dir, SOURCE_URL + test_images_file)
    test_labels_file = 't10k-labels-idx1-ubyte.gz'
    local_test_labels_file = download_and_ungzip(test_labels_file, data_dir, SOURCE_URL + test_labels_file)
